...
router.get('/FT/getAllPodsInfo', authenticateJWT, podController.getAllFTPodsInfo);
...
router.get('/NFT/getAllPodsInfo', authenticateJWT, podController.getAllNFTPodsInfo);
