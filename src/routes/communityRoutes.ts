...
// communities
router.get('/getCommunities/:pagination', authenticateJWT, communityController.getCommunities);
...
router.post('/signTransactionAcceptOffer', authenticateJWT, communityController.signTransactionAcceptOffer);
