...
import {Transaction} from 'ethereumjs-tx';  //only works for ethereumjs-tx version:1.3.7


exports.getEthBalance = async (req: express.Request, res: express.Response) => {
    try {
...
exports.transferEthWithdraw = async (req: express.Request, res: express.Response) => {    
    const body = req.body;
