...
exports.stakeToken = async (req: express.Request, res: express.Response) => {
  try {
    ...
    if (blockchainRes && blockchainRes.success) {
      ...
      console.log(
        "Error in controllers/stakingController -> stakeToken(): success = false",
    ...
    console.log(
      "Error in controllers/stakingController -> stakeToken(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.verifyProfileStaking = async (
  ...
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> verifyProfileStaking(): ",
      e
    );
    res.send({ success: false });
  }
...
exports.verifyPodStaking = async (
  req: express.Request,
  res: express.Response
) => {
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> verifyPodStaking(): ",
      e
    );
    res.send({ success: false });
  }
...
exports.getStakingAmount = async (
  req: express.Request,
  res: express.Response
) => {
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> getStakings(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.getTotalMembers = async (
  ...
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> getTotalMembers(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.getReturnHistory = async (
  req: express.Request,
  res: express.Response
) => {
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> getReturnHistory(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.getStakedHistory = async (
  req: express.Request,
  res: express.Response
) => {
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> getStakedHistory(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.getStakedAmounts = async (
  req: express.Request,
  res: express.Response
) => {
  try {
    ...
    console.log(
      "Error in controllers/stakingController -> getStakedAmounts(): ",
      err
    );
    res.send({ success: false });
  }
...
exports.saveStakingAmountEndOfDay = cron.schedule("0 0 * * *", async () => {
  try {
    console.log(
      "********* Staking saveStakingAmountEndOfDay() cron job started *********"
    );
    ...
    console.log(
      "Error in controllers/stakingController -> manageStakedAmount()",
      err
    );
  }
});
...
exports.saveStakingAmountEndOfWeek = cron.schedule("0 0 * * 0", async () => {
  try {
    console.log(
      "********* Staking saveStakingAmountEndOfWeek() cron job started *********"
    );
    const userSnaps = await db.collection(collections.user).get();
    for (let doc of userSnaps.docs) {
      const uid = doc.id;
...
exports.saveStakingAmountEndOfMonth = cron.schedule("0 0 1 * *", async () => {
  try {
    console.log(
      "********* Staking saveStakingAmountEndOfMonth() cron job started *********"
    );
    const userSnaps = await db.collection(collections.user).get();
    for (let doc of userSnaps.docs) {
      const uid = doc.id;
...
exports.manageStakedAmount = cron.schedule("0 0 * * *", async () => {
  try {
    console.log(
      "********* Staking manageStakedAmount() cron job started *********"
    );
    const stakingTokensSnap = await db
      .collection(collections.stakingToken)
      .get();
...
exports.manageReturns = cron.schedule("0 0 * * *", async () => {
  try {
    ...
    for (let i = 0; i < tokenDocs.length; i++) {
      ...
      const blockchainRes = await priviGovernance.payStakingReward(
        token,
        apiKey
      );
      if (blockchainRes && blockchainRes.success) {
        ...
        const txns = blockchainRes.output
          ? blockchainRes.output.Transactions
          : {};
        let tid: string = "";
        let tobj: any = null;
        ...
        console.log(
          "Error in controllers/stakingController -> manageReturns()",
          blockchainRes.message
        );
      }
    }
